...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '定时任务日志' ROW_FORMAT = Compact;
...
INSERT INTO `sys_config` VALUES (3, 's', 's', 1, 's');
...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES (1, 0, '宿洁', 0, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单管理' ROW_FORMAT = Compact;
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '系统管理员', '无', 1, '2019-08-16 10:37:32');
...
CREATE TABLE `sys_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 40 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色与菜单对应关系' ROW_FORMAT = Compact;
...
INSERT INTO `sys_user` VALUES (2, '1', 'dda694156b2ab7280772ece2d6b8f5ef53948fa020c0c65958c95f45462bd4a7', 'WHope1YmAlFi4gJc9nCl', '1@qq.com', '1', 1, 1, '2019-08-16 11:12:51');
